...
3. Install the example by entering the following command in
   the ServiceMix console:
     ...
     bundle:install mvn:org.apache.servicemix.examples/activiti-camel/7.0.0.M2
...
and looking for a line that looks like this one
  ...
  [ 317] [Active     ] [Created     ] [       ] [   80] Apache ServiceMix :: Examples :: Activiti :: Activiti Camel (7.0.0.M2)
